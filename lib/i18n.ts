...
const s: Record<string, Record<Lang, string>> = {
  ...
  proj_pwnai_desc:    { en: "Autonomous pentesting SaaS. AI agent orchestrates 50+ security tools, chains exploits, and generates professional reports.", fr: "SaaS de pentest autonome. Un agent IA orchestre 50+ outils de sécurité, enchaîne les exploits et génère des rapports professionnels.", ar: "SaaS de pentest autonome. Un agent IA orchestre 50+ outils de sécurité." },
  proj_bookshelf_desc: { en: "Room booking REST API with conflict detection, JWT auth, role-based access, and Zod validation.", fr: "API REST de réservation de salles avec détection de conflits, auth JWT, accès par rôle et validation Zod.", ar: "API REST de réservation de salles avec détection de conflits." },
